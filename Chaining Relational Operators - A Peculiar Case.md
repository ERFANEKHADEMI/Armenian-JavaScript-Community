# JavaScript-ի զվարճալի տարօրինակությունները շարքից՝ 1 < 2 < 3 արտահայտությունը ճիշտ է, սակայն 3 > 2 > 1-ը՝ սխալ: Զանգվածների գումարման չափազանց տարօրինակ հետևանքները: Նաև parseInt ֆունկցիայի 18+ արկածների մասին:
